...
<html>
    ...
    <form>
        <div id="wrap">
        <div id="header" >
            <a href="index.php"><img  src="icon/logo_chinh.png" style="width:50px;height:60px;float:left;margin-left:15px"></a>
        ...
        <div id="map_data">
            ...
            <div id='menu'>
                <div id="rowMenu"><i id="exitMenu" class="fas fa-backspace" style=" font-size:1.33em;float:right; margin-right:10px;color:black"></i>
                    <h1 style="margin: 20px 0 0 30px ; color:#f52418">Cảnh báo COVID-19 <i class="fas fa-bomb"></i> </h1>
                </div>
                <div style="padding:0 18px 0 15px">
                    <p>Những người bị nhiễm vi-rút này có thể cảm thấy không khỏe trong thời gian từ 1 đến 14 ngày trước khi xuất hiện các triệu chứng. Các triệu chứng thường gặp nhất của bệnh do vi-rút corona (COVID-19) là sốt, mệt mỏi và ho khan. Hầu hết bệnh nhân (khoảng 80%) đều khỏi bệnh mà không cần phải điều trị đặc biệt.
</p>

                    <p>Trong trường hợp hiếm gặp hơn, bệnh có thể trở nên nghiêm trọng và thậm chí gây tử vong. Người già và những người mắc các bệnh lý nền khác (chẳng hạn như hen suyễn, tiểu đường hoặc bệnh tim) là đối tượng dễ gặp phải các biến chứng nghiêm trọng hơn.
</p>
<hr>
                    <p>Bệnh nhân có thể gặp phải các triệu chứng sau:</p>                
                    <p style="color:#f52418">Ho khan, Đau họng</p>
                    <p style="color:#f52418">Khó Thở</p>
                    <p style="color:#f52418">Sốt <i class="fas fa-temperature-high"></i></p>
                    <p style="color:#f52418">Mệt mỏi, Đau đầu</p>
                    <p>Nếu bạn mắc những triệu chứng trên cần thông báo nhanh nhất đến bệnh viện, chính quyền để được hỗ trợ , phòng tránh lây lan ngay cả khi mình không bị virut. <b style="color:#f52418">Ở NHÀ LÀ YÊU NƯỚC!</b></p>
                </div>
            </div>
            <div id="map-canvas">
        </div>
